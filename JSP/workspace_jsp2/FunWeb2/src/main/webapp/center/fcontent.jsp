...
<li><a href="./FileBoardList.bo">Driver Download</a></li> <!-- 파일 업로드, 다운 -->
...
<img src="./upload/<%=dto.getFile() %>"" width="50" height="50">  <!-- 이거 해주면 첨부파일 썸네일로 보임 -->
</td></tr>	
<tr><td>글내용</td><td><%=dto.getContent() %></td></tr>	
</table>
<div id="table_search">
<%
// 글쓴이dto.getName()  로그인(session에 id값 담아옴)	 일치하면 => 글수정, 글삭제 보이기
if(id!=null) { //로그인 한사람이 있으면
	if(dto.getName().equals(id)) { //글쓴이와 로그인 한 사람이 일치하면 글수정,삭제가 가능하게 함
		%>
	<input type="button" value="글수정" class="btn"
 	onclick="location.href='./FileBoardUpdate.bo?num=<%=dto.getNum() %>'">
