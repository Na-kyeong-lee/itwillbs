...
public class Ex6 {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * - throws 키워드를 통해 예외를 위힘하는 경우 예외가 발생한 위치에서는
		 ...
		 * 
		 * ex) throws ArithmeticException, NullPointerException 기술시
		 *     두 개의 예외만 외부로 던지로, 나머지 예외는 직접 처리해야한다!
		 * 
...
//		        현재 위치가 main() 메서드이며 main() 메서드에서 위암할 경우
...
//			System.out.println("팀장이 Runtime 계열 예외를 모두 처리");
//		} catch(Exception e) {
...
//		}
		...
		//    1. 모든 클래스를 각각 명시
		//    2. RuntimeException 과 ClassNotFoundException, SQLException 으로 명시
	...
	public static void 대리1() throws ArithmeticException, NullPointerException {
		// 사원1,2 에서 예외가 발생했을 때 위임 (throws) 된 경우
		// 1) 대리1() 메서드에서 직접 위임된 예외를 처리
//		try {
//			사원1();
//			사원2();
//		} catch (ArithmeticException e) {
//			System.out.println("사원1로부터 위임받은 예외를 대리1 직접 처리");
//		} catch (NullPointerException e) {
//			System.out.println("사원2로부터 위임받은 예외를 대리1 직접 처리");
//		}
	...
	public static void 대리2() throws Exception {
		사원3(); // ClassotFoundException
		사원4(); // SQLException
		// => 하나의 예외로 묶어서 던지려면 공통 클래스인 Exception 클래스 사용
	}
...
//		} catch (ArithmeticException e) {
//			System.out.println("사원1에서 예외를 직접 처리!");
//		}
