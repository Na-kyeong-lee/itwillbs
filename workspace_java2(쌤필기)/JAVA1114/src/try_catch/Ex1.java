...
public class Ex1 {
	...
	public static void main(String[] args) {
		/*
		 * 오류 (Error)
		 * - 프로그램 자체 또는 JVM 등 치명적인 원인으로 인해 발생하는 문제점
		 ...
		 *   
		 * < 예외 관련 용어 >
		 * 1. 예외가 발생했을 때 예외 발생여부를 감지하는 대상: 리스너(Listener)
		 * 2. 예외가 발생했을 때 정상적으로 종료될 수 있도록 처리하는 것: 예외처리
		 *    => 예외가 발생하지 않도록 미리 원인을 제거하는 것은 예외처리가 아니며
...
//		System.out.println(num1 + " / " + num2 + " = " + (num1 / num2));
		// => 예외 발생 코드 아래쪽의 나머지 코드는 실행되지 못한채 비정상 종료됨
		/*
		 ...
		 * 	  => 예외 발생 위치 (Ex1.java 클래스의 30번 라인에서 예외 발생)
		 * 
		 * */
...
//		}
		...
		String str = null;// 참조변수에 저장된 주소값이 없음
