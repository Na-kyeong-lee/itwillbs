...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 *   => 따라서, 추상메서드를 갖는 클래스는 반드시 추상클래스로 선언되어야한다!
		 ...
		 * - 추상클래스는 추상메서드, 일반메서드, 생성자, 멤버변수를 모두 가질 수 있음
		 * - 상속을 통해 서브클래에서 사용 가능하며
		 *   업캐스팅을 통한 다형성 활용 가능
...
class SubClass extends AbstractClass {
	...
	// 반드시 오버라이딩을 통해 추상메서드의 구현부(바디{})를 정의 해야한다!
