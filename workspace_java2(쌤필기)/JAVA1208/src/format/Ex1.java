...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 		- 주의사항! LocalDate 또는 LocalTime 의 경우 존재하지 않는 항목에 대해
		 *        패턴이 지정될 경우 예외가 발생할 수 있다!
		 * */
		...
		//    => 지정된 패턴에 따라 Date 객체의 날짜 및 시간 표현을 변경한 문자열 리턴
		...
		String pattern2 = "yyyy년 MM월 d일 E a hh:mm:ss";
