...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *    공통 모듈을 통해 테스트가 추생되기 때문에 개발 기간이 단축된다!  
		 * */
		// 개발자 코드 동작 확인
...
// 개발자와 디자이너가 수행해야하는 작업들의 공통 부분을 추상메서드로 정의하여
// 기본적인 틀을 제시하면 개발자와 디자이너는 각각 별도로 독립된 작업 수행이 가능하다!
interface LoginInterface {
	// 디자이너는 입력받은 id, password를 문자열로 전달
...
class DesinerLogin implements LoginInterface {
	...
	public void inputLoginInfo() {
		...
		// 공통메서드인 login() 메서드를 호출하여 파라미터가 잘 전달되었는지 확인하고
