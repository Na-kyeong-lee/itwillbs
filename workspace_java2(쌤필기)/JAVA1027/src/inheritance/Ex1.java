...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		// 슈퍼클래스인 Parent 클래스로 부터 상속받은 멤버도 선언 없이 사용 가능
		c.name = "홍길동";
		c.parentPrn();
...
//		p.childPrn(); // 서브클래스의 멤버는 접근 불가능 하므로 오류 발생! (자기 것 아니라서 접근 안됨)
...
// 아버지 클래스 정의 - 할아버지 클래스로 부터 상속
// => 멤버변수: car(문자열) -> "자동차" 로 초기화
// => 메서드: drawWell() 메서드 정의 "그림을 잘 그린다!" 출력
...
// => 메서드: programmingWell() 메서드 정의 "프로그래밍을 잘 한다!" 출력
class 나 extends 아버지 {
	String pc = "컴퓨터";
