...
비밀번호 : <input type="text" id="pass" name="pass" onkeyup="checkPass(this.value)"><br>
<span id="checkPassResult"><!-- 패스워드 규칙 판별 결과 표시 영역 --></span><br>
비밀번호 확인 : <input type="text" id="pass2" name="pass2" onkeyup="checkRetypePass()"><br>
<span id="checkRetypePassResult"><!-- 패스워드 규칙 판별 결과 표시 영역 --></span><br>
이름 : <input type="text" name="name"><br>
<input type="submit" value="회원가입">

전화번호 : <input type="text" id="phone" name="phone" onkeyup="replacePhone()" onkeydown="replacePhone()"><br>
